...
if st.session_state.analysis_ready:
    ...
    with st.spinner("🚀 AI 분석 엔진 가동 중... 잠시만 기다려주세요."):
        try:
            ...
            with tab4:
                st.subheader("억양 분석 (Pitch Contour)")
                ...
                ax1.set_title("Your Pitch"); ax2.set_title("Native Pitch")
                st.pyplot(fig_p)
